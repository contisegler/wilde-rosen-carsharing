<script setup lang="ts">
  ...
  const kangooDamageImages = ref<DamageEntry[]>([
    {
      path: "signal-2025-05-18-194106.jpeg",
      side: "back",
      x: 51,
      y: 78,
      ...
      detail_paths: [
        {
          path: "signal-2025-05-18-194106.jpeg",
          title: "Kratzer an der Stoßstange hinten, bzw. der Laderampe zum Kofferraum.",
        },
      ],
    },
    {
      path: "signal-2025-05-18-194231.jpeg",
      side: "left",
      x: 13,
      y: 61,
    ...
    {
      path: "signal-2025-05-18-194245.jpeg",
      side: "right",
      x: 79,
      y: 80,
...
<template>
  <div>
    <CarDamageViewer :damage-entries="kangooDamageImages" car-model="kangoo" title="Kangoo" />
  </div>
</template>
