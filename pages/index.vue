  ...
  <div class="text-center">
    ...
    <div class="flex flex-col gap-3 items-center">
      <NuxtLink to="/kangoo" class="w-1/2">
        <Button variant="outline" size="lg" class="w-full">Kangoo</Button>
      </NuxtLink>
      <NuxtLink to="/kona" class="w-1/2">
        <Button variant="outline" size="lg" class="w-full">Kona</Button>
      </NuxtLink>
      <NuxtLink to="/zoe" class="w-1/2">
        <Button variant="outline" size="lg" class="w-full">Zoe</Button>
      </NuxtLink>
