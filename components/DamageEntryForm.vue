      ...
      <div class="w-full max-w-4xl">
        <div class="border rounded shadow">
          <div class="p-4 border-b flex justify-between items-center">
            <h5 class="mb-0">
              Damage Entry ({{ currentImageIndex + 1 }} of
              {{ damageImages.length }})
            </h5>
            <Button
              variant="outline"
          ...
          <div class="p-4">
              ...
              <div class="w-full">
                <div class="flex justify-center pb-6 pr-6">
                  <div class="relative">
                    <!-- Y Slider (Right) -->
                    <div
                      class="absolute right-0 top-0 h-full transform translate-x-6"
                    >
                      <Slider
                        v-model="yPosition"
                        :min="0"
                    ...
                    <!-- X Slider (Bottom) -->
                    <div
                      class="absolute bottom-0 left-0 w-full transform translate-y-6"
                    >
                      <Slider
                        v-model="xPosition"
                        :min="0"
            ...
            <div class="flex justify-between mt-4">
              ...
              <Button variant="default" type="button" @click="nextImage">
                {{
                  currentImageIndex < damageImages.length - 1
                    ? "Next Image"
                    : "Finish"
                }}
              </Button>
